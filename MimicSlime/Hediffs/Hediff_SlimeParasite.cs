        ...
        private void CheckSeverity()
        {
            ...
            else if (this.CurStageIndex == 3 && !severeNotify)
            {
                ...
                try
                {
                    ...
                    List<Hediff> slimeBodyParts = pawn.health.hediffSet.hediffs.FindAll(h => h.def == MimicSlimeDefOf.SlimeStomach || h.def == MimicSlimeDefOf.SlimeTentacle);
                    ...
                    MimicSlimeUtility.AddAbsorbedThought(pawn);
