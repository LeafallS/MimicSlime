...
namespace MimicSlime
{
    ...
    public class MimicSlimeMod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            ls.CheckboxLabeled("TransformIdeo".Translate(),
                ref MimicSlimeModSettings.TransformIdeo,
                "TransformIdeoTip".Translate());

            ls.CheckboxLabeled("StripClothing".Translate(),
                ref MimicSlimeModSettings.StripClothing);
            ...
            ls.CheckboxLabeled("SlimeRainAssault".Translate(),
                ref MimicSlimeModSettings.SlimeRainAssault);
            ...
            string SlimeRainChance = MimicSlimeModSettings.SlimeRainChance.ToString();
            ls.Label("SlimeRainChance".Translate());
            ls.TextFieldNumeric(ref MimicSlimeModSettings.SlimeRainChance, ref SlimeRainChance, 1, 300);
            MimicSlimeModSettings.SlimeRainChance = Mathf.Clamp(MimicSlimeModSettings.SlimeRainChance, 1, 300);
