...
{
    public class QuestNode_Root_MimicSlimeJoinColony : QuestNode_Root_WandererJoin
    {
        ...
        public override Pawn GeneratePawn()
        {
            ...
            if (!MimicSlimeUtility.IsSlime(pawn))
            {
                GenerateSlime(pawn);
            }
            else if(pawn.health.hediffSet.TryGetHediff(MimicSlimeDefOf.ActuallySlime, out var hediff))
            {
                pawn.health.RemoveHediff(hediff);
            }
            pawn.health.AddHediff(MimicSlimeDefOf.MimicSlimeWanderer);
        ...
        private void GenerateSlime(Pawn pawn)
        {
            Pawn slime = MimicSlimeUtility.CreateSlimePawn(MimicSlimeDefOf.MimicSlime_Colonist, Faction.OfPlayer, forceNoGear: false);
        ...
        {
            TaggedString title = "LetterLabelSlimeWandererJoins".Translate(pawn.Named("PAWN")).AdjustedFor(pawn);
            TaggedString letterText = "LetterSlimeWandererJoins".Translate(pawn.Named("PAWN")).AdjustedFor(pawn);
